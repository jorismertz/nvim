...
function M:setup(opts)
  ...
  vim.treesitter.language.register(
    self.config.treesitter_parser,
    self.config.target_filetype
  )

  -- local highlights = {
  --   { "@constant.html", "@comment" }
  -- }
  ...
  -- vim.treesitter.query.parse(highlights, "highlights", self.config.source_file_ext, self.config.treesitter_parser)
